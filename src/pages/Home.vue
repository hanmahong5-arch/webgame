...
<template>
  <div ref="pageRef">
    ...
    <section class="section-dark py-20" aria-label="产品生态">
      <div class="max-w-5xl mx-auto px-6 sm:px-8 lg:px-12">
        <div class="text-center mb-14 reveal-fade-up">
          <h2 class="home-section-title">7 款产品，完整生态</h2>
          <p class="home-section-subtitle">基础设施 → 应用层，产品间互联互通</p>
        </div>
    ...
    <!-- S5: Kova + Lucrum Bento Grid -->
    <section class="section-dark py-24" aria-label="Kova 和 Lucrum">
      <div class="max-w-6xl mx-auto px-6 sm:px-8 lg:px-12">
        <div class="text-center mb-14 reveal-fade-up">
          <h2 class="home-section-title">核心引擎</h2>
          <p class="home-section-subtitle">Agent 持久运行 + AI 量化交易，两大旗舰产品</p>
        </div>
        <div class="bento-grid reveal-fade-up">
          ...
          <div class="bento-card bento-card--tall card-glow" :style="{ '--glow-color': '#B08EFF' }">
            ...
            <h3 class="bento-card-title">
              崩溃无所畏惧，<span style="color:#B08EFF">自动断点续跑</span>
            </h3>
            <p class="bento-card-desc">
              Kova 将 WAL 预写日志引入 Agent 执行引擎。掉电重启后从断点继续，Rust 零 GC 保障 μs 级确定性响应。
            </p>
          ...
          <div class="bento-card card-glow" :style="{ '--glow-color': '#7AFF89' }">
            ...
            <h3 class="bento-card-title">
              自然语言描述，<span style="color:#7AFF89">AI 生成策略</span>
            </h3>
            <p class="bento-card-desc">
              用中文描述交易逻辑，谷神 AI 自动生成可执行策略，内置回测引擎即时验证。
            </p>
            <div class="bento-diagram-wrapper">
              <LucrumChartDiagram />
            </div>
      ...
      <div class="max-w-6xl mx-auto px-6 sm:px-8 lg:px-12">
        <div class="text-center mb-14 reveal-fade-up">
          ...
          <h2 class="product-headline" style="margin-top:16px">
            AI 真正记住你，<br>
            <span style="color:#4AFFCB">无需重复上下文</span>
          </h2>
