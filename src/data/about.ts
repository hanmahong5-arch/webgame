/**
 * About page centralized data
 * Extracted from inline About.vue for data-layer compliance (ADR-006)
 */
...
export const VALUES: CoreValue[] = [
  ...
  {
    title: '用户至上',
    desc: '产品决策从用户痛点出发，持续优化体验，让技术服务于人',
...
export const TECHNOLOGY_HIGHLIGHTS: TechHighlight[] = [
  {
    title: '企业级基础设施',
    desc: '多区域冗余部署，自动故障转移，持续交付流水线确保每次更新安全上线',
    icon: 'M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4',
  },
  {
    title: '全链路安全',
    desc: '传输加密、密钥隔离、细粒度访问控制，保护每一次 API 调用和数据交换',
    icon: 'M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z',
  },
  {
    title: '智能路由',
    desc: '根据模型可用性、延迟和成本自动选择最优路径，确保每个请求获得最佳响应',
